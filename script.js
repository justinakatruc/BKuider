function visualizePath() {
	...
	if (weather() === "Raining") {
		...
		graph.addEdge("thuvien","7e",1);
		graph.addEdge("a4-fe","7e",1);
		
		graph.addEdge("4d","a1l",0);
		graph.addEdge("a1m","thuvien",0);
		graph.addEdge("thuvien","a4-fe",0);
		graph.addEdge("7d","b8-ls",0);
	}
